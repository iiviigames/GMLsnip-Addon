...
function gm_generate(input_str, snippet_name, use_lines, use_docs, use_copy, use_tooltips) {
    ...
    let data_header = (
    	...
    	"<a href=\"https://www.GMLsnip.com/\" target=\"_blank\" title=\"Built with \u2764 by Zack Banack\" style=\"opacity:0.25;color:black; text-decoration:none;\">\u2764</a>" +
    	"</div></div></div>"
    );

    // Tweak-specific additions
    if (use_copy) output_str += '<div id="' + id_copy + '" class="gz_cls_copy_button" title="Copy GML" onclick="gm_clipboard(\'' + id_copy + '\')"></div>';
...
/**
 * Appends additional CSS to the body of the page.
 */
function gm_style() {
    let sty = document.createElement("style");
    sty.id = 'gz_dev_css';
    sty.type = "text/css";
    sty.innerHTML = append_style;
